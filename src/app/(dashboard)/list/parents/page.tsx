...
const ParentListPage = () => {
  ...
  const renderRow = (item: Parent) => (
    <tr
      key={item.id}
      className={`border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'} even:bg-slate-50 text-sm hover:bg-lamaPurpleLight dark:hover:bg-gray-600`}
    >
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            <button 
              type="button"
              title="Filter"
              className="w-8 h-8 flex items-center justify-center rounded-full bg-[#f9f3ff] dark:bg-gray-700"
            >
